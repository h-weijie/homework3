...
//        因为ofInt对应开始颜色int值到终止颜色int值的渐变,从效果上看颜色频繁变化，出现闪烁。
//        而ofArgb对应开始颜色到终止颜色的渐变,从效果上看颜色缓慢变化，自然过渡到另一颜色。
        ...
        ObjectAnimator fadeAnimator=ObjectAnimator.ofFloat(target,"alpha",1, 0.5f);
